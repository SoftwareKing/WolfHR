...
<body topmargin="0" leftmargin="0" onload="onLoad()" marginheight="0" marginwidth="0">
   ...
   <div id="Title_bar">
      <div id="Title_bar_Head">
        ...
        <div id="Title">
          <img src="${pageContext.request.contextPath}/css/message/title_arrow.gif" border="0" height="13" width="13" /> 已发送邮件
        </div>
      ...
      <table class="TableStyle" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tbody id="TableData" class="dataContainer" datakey="outboxList">
         <s:iterator value="#outboxList">
							...
							<td align="center">
								<s:a href="mailAction_deleteFromoutbox.action?id=%{id}" encode="true">删除</s:a> 
							</td>
						</tr>
						</s:iterator>
        </tbody>
