...
//]]>
	...
	<body topmargin="0" leftmargin="0" onload="onLoad()" class="Msg_body"
		...
		<form name="form" enctype="multipart/form-data" method="post">
			<div id="Title_bar">
				<div id="Title_bar_Head">
					...
					<div id="Title">
						<img
							src="${pageContext.request.contextPath}/css/message/title_arrow.gif"
			...
			<table id="MainArea2" style="float: left; height: auto">
				<tbody>
					...
					<tr>
						<td>
							<center>
								<table style="padding: 3px" class="msgBorder" cellpadding="0"
									cellspacing="0" border="0" height="450px" width="95%">
									<tbody>
										<tr>
											<td>
												<table style="background-color: #ffffff" cellpadding="0"
																...
																<table cellpadding="0" cellspacing="0" border="0"
																	...
																	<tbody>
																		<tr class="ItemTitleFont">
																			...
																			<td width="">
																				<select class="SelectStyle" name="priority">
																					<option value="0">
																						重要
																					</option>
																		...
																		<tr class="ItemTitleFont">
																			...
																			<td height="27">
																				<input onfocus="this.select();" class="InputStyle"
																					value="无标题" name="title" type="text" />
																			</td>
															...
															<td>
																<table cellpadding="0" cellspacing="0" border="0"
																	...
																	<tbody>
																		...
																		<tr class="ItemTitleFont">
																			<td class="ItemTitleFont" valign="top" width="60">
																				内容
																			</td>
			...
			<div id="InputDetailBar">
				<input type="image"
					src="${pageContext.request.contextPath}/css/message/send.png"
					onclick="send()" />
			</div>
		</form>
	</body>
