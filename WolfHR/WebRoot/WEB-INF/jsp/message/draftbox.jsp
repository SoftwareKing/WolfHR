  ...
  <form>
    <div id="Title_bar">
      <div id="Title_bar_Head">
        ...
        <div id="Title">
          <img src="${pageContext.request.contextPath}/css/message/title_arrow.gif" border="0" height="13" width="13" /> 草稿消息
        </div>
          ...
          <s:iterator value="#draftboxList" id="messags">
			<tr onclick="content_onclick('d0');" class="TableDetail2" id="d0">
				...
				<td align="CENTER">
					...
					<td align="center">
						<s:a href="messageAction_sendFromDraftbox.action?id=%{id}">发送</s:a> 
						<s:a href="messageAction_deleteDraftMessage.action?id=%{id}">删除</s:a> 
						</td>
					</tr>
				</s:iterator>
        </tbody>
