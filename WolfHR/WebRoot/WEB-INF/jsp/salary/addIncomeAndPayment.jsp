...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="incomeAndPaymentAction_addIncomeAndPayment.action" onsubmit="return checkType();" >
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        ...
                        <td><s:textfield name="activatyName" cssClass="InputStyle" id="activatyName"></s:textfield></td>
                    </tr>
                    <tr>
                        <td width="100">贴扣地区</td>
                        <td><s:textfield name="address" cssClass="InputStyle" id="address"></s:textfield></td>
                    </tr>
                    <tr>
                        <td width="100">薪资</td>
                        <td><s:textfield name="activatyMoney" cssClass="InputStyle" id="activatyMoney" ></s:textfield>
