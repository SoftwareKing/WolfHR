...
<body>
 <div id="Title_bar">
    ...
    <center>
      <center>
      <s:form action="usereduAction_add.action">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="90%">
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td><input onfocus="this.select();" class="InputStyle" name="xueli" type="text" /></td>
                ...
                <tr>
                  ...
                  <td><input onfocus="this.select();" class="InputStyle" name="school" type="text" /></td>
