    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        	...
        	<s:iterator>
	            <tr class="TableDetail1 template">
	                ...
	                <td align=center>
						...
						<s:a>设置权限</s:a>
						<s:a action="userAction_initpassword?uid=%{uid}" onclick="return window.confirm('您确认要初始化密码为123456吗?')">初始化密码</s:a>
	                </td>
	            </tr>
            </s:iterator>
        </tbody>
     ...
     <div id="TableTail">
        <div id="TableTail_inside">
            <a href="userAction_addUUI.action"><img src="${pageContext.request.contextPath}/css/images/createNew.png" /></a>
        </div>
    </div>
